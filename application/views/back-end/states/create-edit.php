            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     ...
                     <li class="breadcrumb-item active">States Update</li>
                  </ol>
               </div>
            </div>
         </div>
         ...
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <div class="row mb-4">
                     <div class="col-md-8">
                        <h4 class="card-title">States Update</h4>
                     </div>
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                           <div class="text-center">
                              <a href="<?= site_url('admin/states') ?>" class="btn btn-outline-dark btn-sm align-middle me-2" title="pages" style="float: right;">
                   ...
                   <div class="row mb-2 mt-2">
                        <div class="col-md-6">
                           ...
                           <div class="input-group" id="Country">
                               <?= form_dropdown('country_id',$country,set_value('country_id',$state->state_country_id),'class="form-control"') ?>
                          </div>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="input-group" id="name">
                              <input type="text" class="form-control" placeholder="state name" name="state_name" value="<?= set_value('state_name',$state->state_name) ?>">
