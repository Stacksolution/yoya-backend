         ...
         <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active">Vehicle fare Update</li>
               </ol>
            </div>
         </div>
      </div>
      ...
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               <div class="row mb-4">
                  <div class="col-md-8">
                     <h4 class="card-title">Vehicle fare Update</h4>
                  </div>
               ...
               <div class="row mb-2 mt-2">
                  <div class="col-md-6">
                     ...
                     <div class="input-group" id="country">
                        <?= form_dropdown('country_id',$country,set_value('country_id',$vehiclefare_data->fare_country_id),'class="form-control" id="country_id"') ?>
                     </div>
               ...
               <div class="row mb-2 mt-2">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="input-group" id="vehicle_id">
                        <?= form_dropdown('vehicle_id',$vehicles,set_value('vehicle_id',$vehiclefare_data->fare_vehicle_id),'class="form-control"') ?>
                     </div>
