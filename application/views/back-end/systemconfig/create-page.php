         ...
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <div class="row mb-4">
                     <div class="col-md-8">
                        <h4 class="card-title">New Documents Create</h4>
                     </div>
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                           <div class="text-center">
                              ...
                              <i class="bx bx-arrow-back"></i>New Documents Create
                              </a>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row mb-2 mt-2">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="document_label">
                           <input type="text" class="form-control" placeholder="Document label" name="document_label" value="<?= set_value('document_label') ?>">
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-6">
                        <label>Document Placeholder</label>
                        <div class="input-group" id="document_placeholder">
                           <input type="text" class="form-control" placeholder="Document Placeholder" name="document_placeholder" value="<?= set_value('document_placeholder') ?>">
                        </div>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="document_description">
                           <input type="text" class="form-control" placeholder="Document Description" name="document_description" value="<?= set_value('document_description') ?>">
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-6">
                        <label>Document Minimum Char</label>
                        <div class="input-group" id="document_minimum_char">
                           <input type="text" class="form-control" placeholder="Document Minimum" name="document_minimum_char" value="<?= set_value('document_minimum_char') ?>">
                        </div>
                        <?= form_error('document_minimum_char', '<div class="error">', '</div>'); ?>
                     </div>
                     <div class="col-md-6">
                        <label>Document Maximum Char</label>
                        <div class="input-group" id="document_maximum_char">
                           <input type="text" class="form-control" placeholder="Document Maximum" name="document_maximum_char" value="<?= set_value('document_maximum_char') ?>">
                        </div>
