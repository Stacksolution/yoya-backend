            ...
            <div class="card-body">
               ...
               <div class="row mb-2 mt-2">
                  <div class="col-md-4">
                     ...
                     <div class="input-group" id="rental_name">
                        <input type="text" class="form-control" placeholder="Rental Name" name="rental_name" value="<?= set_value('rental_name',$single->rental_name) ?>">
                     </div>
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="input-group" id="rental_hour_value">
                        <input type="text" class="form-control" placeholder="Rental Hour Value" name="rental_hour_value" value="<?= set_value('rental_hour_value',$single->rental_hour_value) ?>">
                     </div>
                     <?= form_error('rental_hour_value', '<div class="error">', '</div>'); ?>
                  </div>
                  <div class="col-md-4">
                     <label>Rental Distance Value</label>
                     <div class="input-group" id="rental_distance_value">
                        <input type="text" class="form-control" placeholder="Rental Distance Value" name="rental_distance_value" value="<?= set_value('rental_distance_value',$single->rental_distance_value) ?>">
                     </div>
