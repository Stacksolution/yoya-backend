            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     ...
                     <li class="breadcrumb-item active">Package fare Create</li>
                  </ol>
               </div>
            </div>
         </div>
         ...
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <div class="row mb-4">
                     <div class="col-md-8">
                        <h4 class="card-title">Package fare Create</h4>
                     </div>
                  ...
                  <div class="row mb-2 mt-2">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_kilometre_price">
                           <input type="text" class="form-control" placeholder="general price" name="fare_kilometre_price" value="<?= set_value('fare_kilometre_price') ?>">
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_kilometre_from">
                           <input type="text" class="form-control"  name="fare_kilometre_from" value="<?= set_value('fare_kilometre_from') ?>">
                        </div>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_kilometre_to">
                           <input type="text" class="form-control" name="fare_kilometre_to" value="<?= set_value('fare_kilometre_to') ?>">
                        </div>
