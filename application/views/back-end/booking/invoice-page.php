...
<?php include(__DIR__.'/../common/_sidebar.php'); ?>
 ...
 <style>
  ...
  body { margin: 1.6cm; }
   ...
   <?php $user = json_decode($invoices->booking_user_details,true);  ?>
   <?php $book = $invoices; ?>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                     <h4 class="mb-sm-0 font-size-18">Booking Invoice</h4>
                     <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                           <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                           <li class="breadcrumb-item active">Booking Invoice</li>
                        </ol>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="card">
                     <div class="card-body" >
                        <div class="invoice-title">
                           ...
                           <div class="mb-4">
                              <img src="<?= $user['user_image'] ?>" alt="logo" height="70" />
                           </div>
                        </div>
                        <hr>
                        <div class="row">
