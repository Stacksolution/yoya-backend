                     ...
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                            <div class="text-center">
                                <a href="<?= site_url('admin/jobprocessvehicle/create') ?>" class="btn btn-outline-success btn-sm align-middle me-2" title="Job Process" style="float: right;">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="d-flex gap-3">
                                    <a href="<?= site_url('admin/Jobprocessvehicle/edit/'.$data->process_id) ?>" class="btn btn-outline-secondary btn-sm"><i class="mdi mdi-pencil font-size-13"></i></a>
                                 </div>
                              </td>
                           </tr>
                           <?php } ?>
...
<script type="text/javascript">
   ...
   $(document).on('change','.jobprocess-ststus',function(){
    ...
    if (_this.prop('checked') == true){ 
      ...
      $.ajax({
        method: "POST",
        url: "<?= base_url('admin/Jobprocessvehicle/status') ?>",
