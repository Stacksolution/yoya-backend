      ...
      <div class="row">
         <div class="col-md-12"> 
            <div class="card border border-primary">
                ...
                <div class="card-body">
                    <p class="card-text">Here is merged vehicle type in job process and find that application and esy to filter for vehicle search</p>
                </div>
            </div>
         </div>
         <div class="col-12">
                     ...
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                           <div class="text-center">
                              <a href="<?= site_url('admin/jobprocessvehicle') ?>" class="btn btn-outline-dark btn-sm align-middle me-2" title="Pages" style="float: right;">
                  ...
                  <div class="row mb-2 mt-2">
                     ...
                     <div class="col-lg-6">
                       <div class="mb-3">
                           ...
                           <?= form_dropdown('vehicle_type_id',$vehicle,set_value('vehicle_type_id'),'class="form-control"') ?>
