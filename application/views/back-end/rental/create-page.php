         ...
         <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active">Vehicle Rental Fare Create</li>
               </ol>
            </div>
         </div>
      </div>
      ...
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               <div class="row mb-4">
                  <div class="col-md-8">
                     <h4 class="card-title">Vehicle Rental Fare Create</h4>
                  </div>
                  ...
                  <div class="row mb-2 mt-2">
                    <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_per_minutes">
                            <input type="text" class="form-control" placeholder="Per Minutes" name="fare_per_minutes" value="<?= set_value('fare_per_minutes') ?>">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_rental_id">
                            <?= form_dropdown('fare_rental_id',$rentalpakages,set_value('fare_rental_id'),'class="form-control"') ?>
                        </div>
