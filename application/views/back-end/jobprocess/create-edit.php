            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               ...
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     ...
                     <li class="breadcrumb-item active">Job process Update</li>
                  </ol>
               </div>
            </div>
         </div>
         ...
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <div class="row mb-4">
                     <div class="col-md-8">
                        <h4 class="card-title">Job process Update</h4>
                     </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="input-group" id="sale">
                           <div class="input-group" data-toggle="aizuploader" data-type="image">
                              ...
                              <input type="hidden" name="icon" class="selected-files" value="<?= set_value('icon',$process_data->job_process_icon) ?>">
                           </div>
