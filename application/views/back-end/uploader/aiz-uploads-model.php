<div class="modal fade bs-example-modal-xl" id="aizUploaderModal" aria-hidden="true">
                  ...
                  <div class="aiz-uploader-filter pt-1 pb-3 border-bottom mb-4">
                     <div class="row align-items-center gutters-5 gutters-md-10 position-relative">
                        <div class="col-xl-2 col-md-3 col-5">
                           <div class="">
                              <!-- Input -->
                              <select class="form-select form-control-xs aiz-selectpicker" name="aiz-uploader-sort">
