               ...
               <div class="card-body">
                     ...
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                            <div class="text-center">
                                <a href="<?= site_url('admin/countrys/create') ?>" class="btn btn-outline-success btn-sm align-middle me-2" title="states" style="float: right;">
                                    <i class="fas fa-plus"></i> New country
                                </a>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="table-responsive">
                     <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                           <?php foreach($countrys->result() as $key => $data) { ?>
                           <tr>
                              <td><a href="javascript: void(0);" class="text-body fw-bold">#<?= $key + 1 ?></a> </td>
                              <td>
                                 <div class="align-self-center me-3">
                                     <img src="<?= uploads_image($data->country_icon) ?>" class="rounded-circle avatar-xs" alt="">
                                 </div>
                              </td>
