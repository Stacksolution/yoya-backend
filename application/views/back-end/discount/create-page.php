               ...
               <div class="row mb-2 mt-2">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="input-group" id="fare_base_price">
                        <input type="text" class="form-control" placeholder="discount code" name="discount_code" value="<?= set_value('discount_code') ?>">
                     </div>
               ...
               <div class="row mb-2 mt-2">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="input-group" id="discount_minimum_amount">
                        <input type="text" class="form-control" placeholder="Minimum Amount" name="discount_minimum_amount" value="<?= set_value('discount_minimum_amount') ?>">
                     </div>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="input-group" id="discount_user_uses_at_time">
                        <input type="number" class="form-control" placeholder="User Uses" name="discount_user_uses_at_time" value="<?= set_value('discount_user_uses_at_time') ?>">
                     </div>
