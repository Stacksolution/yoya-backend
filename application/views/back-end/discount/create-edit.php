               ...
               <div class="card-body">
                  ...
                  <div class="row mb-2 mt-2">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="input-group" id="state">
                           <?= form_dropdown('state_id',[''=>'--Select State--'],set_value('state_id',@$discounts->discount_state_id),'class="form-control" id="state_id" placeholder="Select State"') ?>
                        </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="input-group" id="city_id">
                           <?= form_dropdown('city_id',[''=>'--Select City--'],set_value('city_id',@$discounts->discount_city_id),'class="form-control" id="city_id" placeholder="Select city" ') ?>
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-3">
                        ...
                        <div class="input-group" id="fare_base_price">
                           <input type="text" class="form-control" placeholder="Discount code" onkeyup="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '');" name="discount_code" value="<?= set_value('discount_code',$discounts->discount_code) ?>">
                        </div>
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="input-group" id="discount_start_date">
                           <input type="date" class="form-control" placeholder="start date" name="discount_start_date" value="<?= set_value('discount_start_date',$discounts->discount_start_date) ?>">
                        </div>
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="input-group" id="discount_end_date">
                           <input type="date" class="form-control" placeholder="end date" name="discount_end_date" value="<?= set_value('discount_end_date',$discounts->discount_end_date) ?>">
                        </div>
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="input-group" id="discount_type">
                           ...
                           <?= form_dropdown('discount_type',$discount_type,set_value('discount_type',$discounts->discount_type),'class="form-control" id="discount_type"') ?>
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-4">
                        ...
                        <?= form_dropdown('discount_job_process_id',$process,set_value('discount_job_process_id',$discounts->discount_job_process_id),'class="form-control"') ?>
                        </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <?= form_dropdown('discount_vehicle_type_id',$vehicletype,set_value('discount_vehicle_type_id',$discounts->discount_vehicle_type_id),'class="form-control"') ?>
                        </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="input-group" id="state">
                        <?= form_dropdown('discount_vehicle_id',$vehicle,set_value('discount_vehicle_id',$discounts->discount_vehicle_id),'class="form-control"') ?>
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-4">
                        ...
                        <div class="input-group" id="discount_amount">
                           <input type="text" class="form-control" placeholder="Discount" name="discount_amount" value="<?= set_value('discount_amount',$discounts->discount_value) ?>">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="input-group" id="discount_user_uses_at_time">
                           <input type="number" class="form-control" placeholder="User Use Limit" name="discount_user_uses_at_time" value="<?= set_value('discount_user_uses_at_time',$discounts->discount_user_uses_at_time) ?>">
                        </div>
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="input-group" id="fare_base_price">
                        <textarea  class="form-control" placeholder="dicount description" name="discount_description"><?= set_value('discount_description',$discounts->discount_description) ?></textarea>
                     </div>
