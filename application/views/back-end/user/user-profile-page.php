                     ...
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                           <div class="text-center">
                              <a href="<?= site_url('admin/dashboard') ?>" class="btn btn-outline-dark btn-sm align-middle me-2" title="Back dashboard " style="float: right;">
                   ...
                   <?= form_open() ?>
                    <div class="col-md-12">
                           ...
                           <div class="input-group" id="Username">
                              <input type="text" class="form-control" placeholder="user name" name="user_username" value="<?= set_value('user_username',$user_data->user_username) ?>">
                              <span class="input-group-text"><i class="bx bx-user"></i></span>
                           </div>
                           <?= form_error('user_username', '<div class="error">', '</div>'); ?>
                      </div>
                     ...
                     <div class="row mb-2 mt-2">
                        <div class="col-md-6">
                           ...
                           <div class="input-group" id="Phone">
                              <input type="text" class="form-control" placeholder="Enter phone" name="user_phone" value="<?= set_value('user_phone',$user_data->user_phone) ?>">
