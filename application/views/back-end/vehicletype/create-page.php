                   ...
                   <?= form_open() ?>
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="input-group" id="name">
                              <input type="text" class="form-control" placeholder="vahicle name" name="vehicle_type_name" value="<?= set_value('vehicle_type_name') ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group" id="sale">
                                  <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="icon" class="selected-files" value="<?= set_value('vehicle_type_icon') ?>">
                                </div>
                       ...
                       <div class="col-md-12">
                           ...
                           <div class="input-group" id="Phone">
                              <textarea  name="vehicle_type_description" placeholder="Description" required class="form-control" rows="3"><?= set_value('vehicle_type_description') ?></textarea
                          </div>
