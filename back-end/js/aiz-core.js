    ...
    AIZ.uploader = {
                            ...
                            $.ajax({
                                ...
                                success: function () {
                                    ...
                                    AIZ.uploader.getAllUploads(
                                        AIZ.data.appUrl +
                                            "/admin/aizuploader/get_uploaded_files"
                                    );
        ...
        showSelectedFiles: function () {
            $('[name="aiz-show-selected"]').on("change", function () {
                if ($(this).is(":checked")) {
                    ...
                    AIZ.uploader.getAllUploads(
                        AIZ.data.appUrl + "/admin/aizuploader/get_uploaded_files"
                    );
                }
                AIZ.uploader.updateUploaderFiles();
            });
        ...
        inputSelectPreviewGenerate: function (elem) {
            ...
            if (AIZ.uploader.data.selectedFiles.length > 0) {
                ...
                $.post(
                    AIZ.data.appUrl + "/admin/aizuploader/get_file_by_ids",
        ...
        trigger: function (
            ...
            //setTimeout(function() {
            $.post(
                AIZ.data.appUrl + "/admin/aizuploader",
                { _token: AIZ.data.csrf },
                function (data) {
                    //$("body").append(data);
        ...
        aizUppy: function () {
            if ($("#aiz-upload-files").length > 0) {
                ...
                uppy.use(Uppy.XHRUpload, {
                    endpoint: AIZ.data.appUrl + "/admin/aizuploader/upload",
                    fieldName: "aiz_file",
                    formData: true,
                    headers: {
