...
(function ($) {
    ...
    function updateThemeSetting(id) {
        if ($("#light-mode-switch").prop("checked") == true && id === "light-mode-switch") {
            ...
            $("#bootstrap-style").attr('href', 'back-end/css/bootstrap.min.css');
            $("#app-style").attr('href', 'back-end/css/app.min.css');
            sessionStorage.setItem("is_visited", "light-mode-switch");
            ...
            $("#rtl-mode-switch").prop("checked", false);
            $("#dark-rtl-mode-switch").prop("checked", false);
            $("#bootstrap-style").attr('href', 'back-end/css/bootstrap-dark.min.css');
            $("#app-style").attr('href', 'back-end/css/app-dark.min.css');
            sessionStorage.setItem("is_visited", "dark-mode-switch");
        } else if ($("#rtl-mode-switch").prop("checked") == true && id === "rtl-mode-switch") {
            $("#light-mode-switch").prop("checked", false);
            $("#dark-mode-switch").prop("checked", false);
            $("#dark-rtl-mode-switch").prop("checked", false);
            $("#bootstrap-style").attr('href', 'back-end/css/bootstrap-rtl.min.css');
            $("#app-style").attr('href', 'back-end/css/app-rtl.min.css');
            $("html").attr("dir", 'rtl');
            ...
            $("#rtl-mode-switch").prop("checked", false);
            $("#dark-mode-switch").prop("checked", false);
            $("#bootstrap-style").attr('href', 'back-end/css/bootstrap-dark-rtl.min.css');
            $("#app-style").attr('href', 'back-end/css/app-dark-rtl.min.css');
            $("html").attr("dir", 'rtl');
